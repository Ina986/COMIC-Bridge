...
function main() {
    ...
    for (var i = 0; i < settings.files.length; i++) {
        var result = processFile(settings.files[i], settings.options, settings.guides);
        results.push(result);
    }
...
function processFile(fileSettings, options, guides) {
    var result = {
    ...
    try {
        ...
        // ==========================================
        // Phase 1: Spec conversion (if needed)
        // ==========================================
        ...
        // ==========================================
        // Phase 2: Guide application (if needed)
        // ==========================================

        if (fileSettings.needs_guide_apply && guides && guides.length > 0) {
